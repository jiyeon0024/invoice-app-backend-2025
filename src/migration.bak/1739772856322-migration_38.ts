...
export class Migration381739772856322 implements MigrationInterface {
  name = "Migration381739772856322";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD "password" character varying NOT NULL DEFAULT 'defaultpassword'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "invoice" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP`
    );
    await queryRunner.query(
