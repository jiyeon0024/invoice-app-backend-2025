...
export class Migration421739773567896 implements MigrationInterface {
    name = 'Migration421739773567896'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "password" SET DEFAULT 'default_password'`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "username"`);
